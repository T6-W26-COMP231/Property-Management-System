...
export default function Home() {
  // --- Data arrays for the features, roles and docs---
  const features = [
    { icon: "bi-cash-coin", title: "Automate Rent Collection", desc: "Set up auto-pay, track pending transactions, and monitor revenue in real time without the spreadsheets." },
    { icon: "bi-tools", title: "Streamline Maintenance", desc: "Tenants submit photo-rich tickets that route directly to approved contractors for faster resolution." },
    { icon: "bi-file-earmark-pdf", title: "Digital Lease Management", desc: "Store, sign, and renew leases securely in the cloud with automated expiration reminders." }
  ];

  const roles = [
    { target: "For Landlords", icon: "bi-building", benefits: ["Portfolio Analytics", "Automated Invoicing", "Contractor Dispatching"] },
    { target: "For Residents", icon: "bi-house-door", benefits: ["One-Click Rent Pay", "Maintenance Tracking", "Direct Messaging"] },
    { target: "For Contractors", icon: "bi-wrench-adjustable", benefits: ["Instant Job Alerts", "Digital Invoicing", "Client Ratings"] }
  ];

  const docs = [
    { title: "Getting Started", desc: "Set up your first property and invite tenants.", icon: "bi-rocket" },
    { title: "Managing Properties", desc: "Learn how to structure multi-unit buildings.", icon: "bi-buildings" },
    { title: "Maintenance Flow", desc: "How to accept and close out repair tickets.", icon: "bi-clipboard-check" },
    { title: "Payment Tracking", desc: "Connect your bank and set up automated ledgers.", icon: "bi-bank" }
  ];
    ...
    <div className="bg-white">
          ...
          <div className="row align-items-center gy-5">
            <div className="col-lg-6 pe-lg-5">
              ...
              <h1 className="display-4 fw-bold mb-4">
                The All-in-One <span className="text-gradient">Property Management</span> Platform
              </h1>
              <p className="lead text-secondary mb-4 pe-md-5">
                Automate rent collection, instantly route maintenance requests, and keep your properties profitable with a modern, friction-free dashboard.
              </p>
              ...
              <div className="mock-dashboard p-1">
                ...
                <div className="p-4 bg-white" style={{ minHeight: '300px' }}>
                  <div className="d-flex justify-content-between mb-4">
                    <div className="w-50 bg-light rounded p-3 border"><small className="text-muted fw-bold">Monthly Revenue</small><h3 className="mb-0 mt-2">$24,500</h3></div>
                    <div className="w-50 bg-light rounded p-3 border ms-3"><small className="text-muted fw-bold">Open Tickets</small><h3 className="mb-0 mt-2 text-danger">3</h3></div>
                  </div>
      ...
      <section className="py-4 border-top border-bottom bg-light bg-opacity-50">
        <div className="container text-center">
          <p className="text-muted fw-semibold small mb-3 text-uppercase tracking-wide">Trusted by modern property managers</p>
          <div className="d-flex justify-content-center flex-wrap gap-4 gap-md-5 align-items-center opacity-50">
            <h5 className="mb-0 fw-bold"><i className="bi bi-buildings-fill me-2"></i>UrbanEstates</h5>
            <h5 className="mb-0 fw-bold"><i className="bi bi-house-check-fill me-2"></i>Skyline Living</h5>
            <h5 className="mb-0 fw-bold"><i className="bi bi-shield-check me-2"></i>99.9% Uptime</h5>
            <h5 className="mb-0 fw-bold"><i className="bi bi-door-open-fill me-2"></i>500+ Units</h5>
          </div>
        </div>
      </section>
      ...
      <section className="py-5 my-5 container">
        <div className="text-center mb-5">
          ...
          <p className="text-muted">Three simple steps to streamline your real estate portfolio.</p>
        </div>
        <div className="row g-4 text-center">
          <div className="col-md-4">
            ...
            <p className="text-muted small px-3">Upload your units, set rent amounts, and attach existing lease documents.</p>
          </div>
          <div className="col-md-4">
            ...
            <p className="text-muted small px-3">Tenants receive a secure link to create their portal and set up payment methods.</p>
          </div>
          <div className="col-md-4">
            ...
            <p className="text-muted small px-3">Monitor incoming rent, dispatch contractors for repairs, and track analytics.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-5 bg-light">
        <div className="container py-4">
          <h2 className="fw-bold text-center mb-5">Enterprise Features, Built for Everyone</h2>
        ...
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-end mb-4">
            <div>
              ...
              <p className="text-light opacity-75 mb-0">Learn how to maximize your PropertyPulse dashboard.</p>
            </div>
            <Link to="/docs" className="btn btn-outline-light d-none d-md-block">View Help Center</Link>
          </div>
            ...
            {docs.map((doc, idx) => (
              <div className="col-md-6 col-lg-3" key={idx}>
                <Link to={`/docs/${idx}`} className="text-decoration-none">
                  <div className="card bg-white bg-opacity-10 border-0 text-white h-100 p-3 hover-lift">
        ...
        <div className="container">
          <div className="row gy-4">
            <div className="col-lg-4 pe-lg-5">
              ...
              <p className="text-muted small">Connecting landlords, residents, and contractors in one seamless platform. Built for the modern real estate portfolio.</p>
            </div>
            ...
            <div className="col-6 col-lg-2">
              ...
              <ul className="list-unstyled text-muted small">
                ...
                <li className="mb-2"><Link to="/guides" className="text-decoration-none text-muted">Landlord Guides</Link></li>
          ...
          <div className="border-top mt-5 pt-4 text-center text-muted small">
            &copy; {new Date().getFullYear()} Property Management System Team 6. All rights reserved.
          </div>
        </div>
      </footer>
